...
Public Class ImpressaoCautelas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Solucoes_Integradas_VB_Net_3_5.ImpressaoCautelas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedImpressaoCautelas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ImpressaoCautelas = New ImpressaoCautelas
        rpt.Site = Me.Site
        Return rpt
    End Function
