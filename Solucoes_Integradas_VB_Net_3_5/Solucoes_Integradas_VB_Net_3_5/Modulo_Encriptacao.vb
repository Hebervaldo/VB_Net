            ...
            Catch ex As System.Security.Cryptography.CryptographicException
                If ex.Message.ToLower.IndexOf("csp for this implementation could not be acquired") > -1 Then
                    Throw New Exception("Unable to obtain Cryptographic Service Provider. " & _
                        ...
                        " does not have Principal to this folder.", ex)
                Else
                    Throw
                End If
            Finally
...
#Region "  Utils"
    ...
    Friend Class Utils
        ...
        ''' </summary>
        Friend Shared Function GetConfigString(ByVal key As String) As String
     ...
     ByVal isRequired As Boolean) As String
        ...
        Friend Shared Function WriteXmlNode(ByVal element As String) As String
            Return WriteXmlNode(element, False)
        End Function

        Friend Shared Function WriteXmlNode(ByVal element As String, ByVal isClosing As Boolean) As String
            Dim s As String
            If isClosing Then
