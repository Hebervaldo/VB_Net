...
Public Class ImpressaoBens
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Solucoes_Integradas_VB_Net_3_5.ImpressaoBens.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedImpressaoBens
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ImpressaoBens = New ImpressaoBens
        rpt.Site = Me.Site
        Return rpt
    End Function
