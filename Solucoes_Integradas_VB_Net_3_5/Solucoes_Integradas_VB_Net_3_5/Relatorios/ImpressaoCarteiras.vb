...
Public Class ImpressaoCarteiras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Solucoes_Integradas_VB_Net_3_5.ImpressaoCarteiras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedImpressaoCarteiras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ImpressaoCarteiras = New ImpressaoCarteiras
        rpt.Site = Me.Site
        Return rpt
    End Function
