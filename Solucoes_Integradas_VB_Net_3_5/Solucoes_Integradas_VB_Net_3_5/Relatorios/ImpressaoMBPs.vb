...
Public Class ImpressaoMBPs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Solucoes_Integradas_VB_Net_3_5.ImpressaoMBPs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedImpressaoMBPs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ImpressaoMBPs = New ImpressaoMBPs
        rpt.Site = Me.Site
        Return rpt
    End Function
