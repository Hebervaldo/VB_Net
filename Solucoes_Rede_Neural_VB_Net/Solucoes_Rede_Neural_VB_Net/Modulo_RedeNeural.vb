...
Module Modulo_RedeNeural
    Public Class clsRedeNeural
        ...
        Private tipoerro As String = String.Empty, tiposaida As String = String.Empty, _
        ...
        End Function
        Public Overloads Function mtdExecutar(ByRef entrada(,) As Double, ByRef target(,) As Double, ByVal NumeroEscondida As Integer, _
        ByVal NumeroIteracoes As Integer, ByRef erro As Double, ByVal erro_max As Double, ByVal tiposaida As String, ByVal tipoerro As String, _
        ByVal tipodelta As String, ByRef resultado As String, ByRef strerro As String, ByRef strpesos As String, _
        ByRef epocaporcent As Double, ByRef tempoexecucao As Date, ByVal ModoOperacao As String) As Boolean
            ...
            For k = 1 To NumSaida Step 1 ' inicializa W23 e DeltaW23 
                ...
                Next
            Next
            Return mtdRotina(entrada, target, W12, W23, NumeroEscondida, NumeroIteracoes, erro, erro_max, tiposaida, tipoerro, _
            tipodelta, resultado, strerro, strpesos, epocaporcent, tempoexecucao)
        End Function
        Public Overloads Function mtdExecutar(ByRef entrada(,) As Double, ByRef target(,) As Double, ByRef W12(,) As Double, _
        ByRef W23(,) As Double, ByVal NumeroEscondida As Integer, ByVal NumeroIteracoes As Integer, ByRef erro As Double, ByVal erro_max As Double, _
        ByVal tiposaida As String, ByVal tipoerro As String, ByVal tipodelta As String, ByRef resultado As String, ByRef strerro As String, _
        ByRef strpesos As String, ByRef epocaporcent As Double, ByRef tempoexecucao As Date, ByVal ModoOperacao As String) As Boolean
            ...
            tipodelta, resultado, strerro, strpesos, epocaporcent, tempoexecucao)
        End Function
        Private Function mtdRotina(ByVal entrada(,) As Double, ByVal target(,) As Double, ByRef W12(,) As Double, ByRef W23(,) As Double, ByVal NumeroEscondida As Integer, _
        ByVal NumeroIteracoes As Integer, ByRef erro As Double, ByVal erro_max As Double, ByVal tiposaida As String, ByVal tipoerro As String, _
        ByVal tipodelta As String, ByRef resultado As String, ByRef strerro As String, ByRef strpesos As String, _
