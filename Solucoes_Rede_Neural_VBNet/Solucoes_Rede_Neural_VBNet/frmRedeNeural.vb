...
Namespace Solucoes_Rede_Neural_VBNet
    Public Class frmRedeNeural
        ...
        Public Shared NumeroEntrada As Integer, NumeroPadroes As Integer, NumeroPadroesConferencia As Integer, NumeroSaida As Integer, _
    NumeroEscondida As Integer, NumeroIteracoes As Integer
        ...
        Private tipoerro As String = String.Empty, tiposaida As String = String.Empty, tipodelta As String = String.Empty, _
        ...
        Private Sub RotinaThreadExecutar()
            ...
            Try
                ...
                Select Case tipotarefa
                    Case "Aprendizagem"
                        If objRedeNeural.mtdExecutar(entrada, target, NumeroEscondida, NumeroIteracoes, erro, erro_max, tiposaida, _
            tipoerro, tipodelta, resultado, strerro, strpesos, epocaporcent, tempoexecucao, tipotarefa) Then
                    ...
                    Case "Verificação"
                        ...
                        If objRedeNeural.mtdExecutar(entrada, target, W12, W23, NumeroEscondida, NumeroIteracoes, erro, erro_max, tiposaida, _
            tipoerro, tipodelta, resultado, strerro, strpesos, epocaporcent, tempoexecucao, tipotarefa) Then
                            objArquivoTXT.mtdCriadorTexto(ENDERECOARQUIVOERRO, strerro)
                            objArquivoTXT.mtdCriadorTexto(ENDERECOARQUIVORESULTADOS, resultado)
                            MessageBox.Show("A tarefa foi concluída.", "Aviso!", MessageBoxButtons.OK)
