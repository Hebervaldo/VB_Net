Namespace Solucoes_Integradas_VB_Net_3_5
    Partial Public Class frmImportadorBaseDadosPrincipal
        ...
        Private objBDPrincipal As clsImplementacaoBancoDados = New clsImplementacaoBancoDados(frmPrincipal.strConexaoBancoDadosPrincipal, clsBancoDados.TipoSistemaGerenciadorBancoDadosRelacional.OleDb)
        ...
        Private Sub frmImportadorBaseDadosPrincipal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            txt2.Text = String.Format("{0}{1}", frmPrincipal.strEnderecoBancoDadosPrincipal, frmPrincipal.strNomeBaseDadosPrincipal)
            mtdIniciarThreadImportarTabelaBensEletronorteCentroCustoPrincipal()
        ...
        Private Shared LockImportadorBaseDadosPrincipal As Object = New Object()
        ...
        Private Sub mtdRotinaThreadProgresso()
            ...
            Try
                Do
                    SyncLock (LockImportadorBaseDadosPrincipal)
        ...
        Protected Friend Sub mtdAbortarProcessos()
            Try
                ThProgresso.Abort(True)
            Catch
            End Try
            mtdAbortarThreadImportarTabelaBensEletronorteCentroCustoPrincipal()
        End Sub
